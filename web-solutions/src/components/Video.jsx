...
export function Video() {
  ...
  return (
    <section className="bg-primaryBg py-20 lg:py-[120px]">
            ...
            <div className="relative z-20 h-[300px] overflow-hidden rounded-lg md:h-[450px]">
              ...
              >
                <a
                  ...
                  className="absolute z-20 flex h-20 w-20 items-center justify-center rounded-full bg-white text-greenPrimary md:h-[100px] md:w-[100px] cursor-pointer"
                >
      ...
      {videoOpen && (
        <div className="fixed left-0 top-0 z-50 flex h-screen w-full items-center justify-center bg-black bg-opacity-70">
          ...
          <button
            ...
            className="absolute right-0 top-0 flex h-20 w-20 cursor-pointer items-center justify-center text-white hover:bg-black"
          >
