        ...
        <>
            <div className="grid grid-cols-2 grid-rows-[100px_repeat(10,80px)] px-6 gap-y-6 gap-x-8 py-50 ">
                <div className="flex flex-col gap-6 text-white row-span-3 px-5">
                    ...
                    <NavLink to='/portfolio' id="learn_more" className="flex gap-2 border border-white bg-white w-10/12 justify-center items-center py-3 transition-all duration-500 ease-in-out hover:bg-gray-200" >
