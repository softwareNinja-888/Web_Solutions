...
export function SuccessMsg({ isVisible = true, setIsVisible }) {
    ...
    <AnimatePresence>
      {isVisible && (
        <motion.section
          ...
          className="bg-gray-2 py-[60px] dark:bg-dark fixed top-0 right-0 z-100"
        >
          <div ref={domNode} className="mx-auto px-4 sm:container">
            <div className="relative flex max-w-[422px] items-center rounded-lg border border-stroke bg-white p-4 py-[18px] shadow-pricing-4 sm:px-[30px] dark:border-dark-3 dark:bg-dark-2 dark:shadow-box-dark">
              <div className="mr-5 flex h-10 w-full max-w-[40px] items-center justify-center rounded-full bg-greenPrimary">
                <svg
                  width={24}
                  height={25}
                  viewBox="0 0 24 25"
              ...
              <div className="flex w-full items-center justify-between">
                ...
                <button
                  className="text-black hover:text-greenPrimary duration-500 transition-all hover:rotate-180 cursor-pointer"
