export function TestimonialCard({name='Leslie Alexander',position='Operations Manager',text='You made it so simple. My new site is so much faster and easier to work with than my old site. I just choose the page, make the change.'}){
    return (
        <>
                ...
                <div className="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                    ...
                    <div className="flex items-center mt-8">
                        ...
                        <div className="ml-4">
                            ...
                            <p className="mt-0.5 text-sm font-pj text-gray-600">{position}</p>
                        </div>
                    </div>
                </div>
            </div>
